...
if (isset($_SESSION['username'])) {
    ...
    echo '      <h3 class="login col-lg-2 col-lg-offset-9 col-md-2 col-md-offset-8 col-sm-offset-8 col-sm-2 col-xs-2 col-xs-offset-6"><a href="home.php">DASHBOARD</a></h3>';
